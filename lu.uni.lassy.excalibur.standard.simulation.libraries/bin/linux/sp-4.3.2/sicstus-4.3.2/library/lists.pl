...
%@  a list, and appending @var{L1}, ..., @var{Ln} together yields @var{List}.  The
...
%@  is true when @var{List} and @var{Perm} are permuations of each other.
%@  Unlike @code{perm/2}, it will work even when @var{List} is not a proper list.
%@  It even acts in a marginally sensible way when @var{Perm} isn't proper
...
%@  @item increasing_prefix(@var{?Sequence}, @var{?Prefix}, @var{?Tail})
%@  is true when @code{append(Prefix, Tail, Sequence)}
%@  and @var{Prefix}, together with the first element of @var{Tail},
...
%@  that the first element of @var{Tail} would be included in @var{Prefix}.
...
%@  @item increasing_prefix(@var{:Order}, @var{?Sequence}, @var{?Prefix}, @var{?Tail})
...
%@  @item decreasing_prefix(@var{?Sequence}, @var{?Prefix}, @var{?Tail})
%@  @itemx decreasing_prefix(@var{:Order}, @var{?Sequence}, @var{?Prefix}, @var{?Tail})
